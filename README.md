...
cd media-hub
git switch feature/youtube-web-mvp
...
- `POST /api/jobs`: cria um job;
- `GET /api/jobs/{job_id}`: consulta status e resultado;
- `GET /api/jobs/{job_id}/files/{filename}`: baixa um artefato permitido.
